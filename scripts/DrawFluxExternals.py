...
leg.AddEntry(h_g3,"pass 1m water shield")
...
#c_g.SaveAs(outdir+"fluxGamma_200Water5Cui_2step.png")


leg_n = TLegend(0.3,0.7,0.65,0.85)
...
leg_n.AddEntry(h_n3,"pass 1m water shield")
