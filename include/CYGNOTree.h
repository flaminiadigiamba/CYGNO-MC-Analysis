...
// Fri Jul 26 21:00:59 2019 by ROOT version 6.12/06
// from TTree nTuple/tree
// found on file: /storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/50Water8Pb2Cu_fix/Geo50Water8Pb2Cu_CYGNOtest_surface_gamma_part49.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
  // if (tree == 0) {
  //    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/50Water8Pb2Cu_fix/Geo50Water8Pb2Cu_CYGNOtest_surface_gamma_part49.root");
  //    if (!f || !f->IsOpen()) {
  //       f = new TFile("/storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/50Water8Pb2Cu_fix/Geo50Water8Pb2Cu_CYGNOtest_surface_gamma_part49.root");
  //    }
