...
// Fri Jul  5 10:54:33 2019 by ROOT version 6.12/06
// from TTree nTuple/tree
// found on file: /ua9/data/CYGNO/CYGNO-MC-data/bsub_outputs/gamma_fullshield_opt1-pt3/CYGNOtest_surface_gamma_fullshield_template_part1.root
//////////////////////////////////////////////////////////
...
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/ua9/data/CYGNO/CYGNO-MC-data/bsub_outputs/gamma_fullshield_opt1-pt3/CYGNOtest_surface_gamma_fullshield_template_part1.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/ua9/data/CYGNO/CYGNO-MC-data/bsub_outputs/gamma_fullshield_opt1-pt3/CYGNOtest_surface_gamma_fullshield_template_part1.root");
//      }
