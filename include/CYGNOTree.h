...
// Fri Feb 14 09:21:50 2020 by ROOT version 6.12/06
// from TTree nTuple/tree
// found on file: /storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/gamma_50Water5Cu_inputdist50Water_noflu/CYGNO_surface_gamma_50Water5Cu_inputdist50Water_noflu_part142.root
//////////////////////////////////////////////////////////
...
//   if (tree == 0) {
//      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/gamma_50Water5Cu_inputdist50Water_noflu/CYGNO_surface_gamma_50Water5Cu_inputdist50Water_noflu_part142.root");
//      if (!f || !f->IsOpen()) {
//         f = new TFile("/storage/DATA-03/cygnorm3/CYGNO-MC-data/pbs_outputs/gamma_50Water5Cu_inputdist50Water_noflu/CYGNO_surface_gamma_50Water5Cu_inputdist50Water_noflu_part142.root");
//      }
